/* 클라이언트가 보낸 데이터 읽기 - GET 요청으로 보낸 데이터 읽기
 * 
*/
...
public class Servlet01 extends  GenericServlet{
    ...
    public void service(ServletRequest req, ServletResponse res) throws ServletException, IOException {
        ...
        // http://localhost:8888/ex04/servlet01?name=aaaa&age=10&working=true
        // 테스트 :
        // => http://localhost:8888/ex04/get.html
...
/*
GET /ex04/servlet01?name=aaaa&age=10&working=true HTTP/1.1
Host: localhost:8888
...
name=aaaa&age=10&working=true
*/


//GET요청의 특징 
//- URL에 데이터를 포함
// => 즐겨찾기에 데이터를 포함하여 URL에 저장할 수 있다
// => 그래서 링크를 누르면 결과 화면으로 바로 이동 할 수 있다
...
//-바이너리 데이터 전송
// => request-URI에 포함할 수있는 것은 테스트이기 때문에
// => 바이너리 데이터(이미지, 엑셀, 영상 등)를 전송하는데 적합하지 않다.
// => Base64 인코딩을 이용하여 바이너리 데이터를 텍스트 데이터로 변환한 다음에 보낼 수 있다.
