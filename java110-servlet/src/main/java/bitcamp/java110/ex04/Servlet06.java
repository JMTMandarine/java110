...
public class Servlet06 extends  GenericServlet{
    ...
    public void service(ServletRequest req, ServletResponse res) throws ServletException, IOException {
        ...
        // 주의! 
        // GET 요청할 때 URL에 한글이 포함될  경우 POST처럼 따로 설정하지 않아도 된다.
        // 그런데 톰캣 7이하에서는 server.xml에 설정을 해줘야 한글이 깨지지 않음.
        
        
        // 다음은 POST 요청으로 들어온 한글 데이터를 처리할 때 사용하는 것이다.
        // GET 요청에 대해서는 setcharacterEncodding()이 효력이 없다.
