 ...
 *       - 생성시점 : 웹애플리케이션이 시작될 때 각 웹애플리케이션 마다 한개의 보관소가 생성됨.
 *       - 소멸시점 : 웹애플리케이션이 종료될 때.
 *       - 저장하는 대상 
...
public class Servlet01 extends  HttpServlet{
    ...
    public Servlet01() {
        System.out.println("ex07.Servlet01... 생성자 호출");
    }
    
    @Override
    public void init() throws ServletException {
        System.out.println("ex07.Servlet01.init()... init()호출");
    }
