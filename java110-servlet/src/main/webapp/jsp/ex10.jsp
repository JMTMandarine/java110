...
<pre>
- 외부 JSP 확장 태그를 가져올 때 사용한다.
    %@ taglib prefix="별명" url="JSP확장태그의 네임 스페이스"%>
- JSP에 제공하는 전용 태그 외에 개발자가 정의한 태그를 가져와서 사용할 수 있다.
...
- JSTL 사용법?
    ...
    JSTL 태그를 사용하는 JSP 페이지에서는 taglib 지시명령어를 통해 
...
<ul>
<c:forTokens var="name" items="만다린,마인부우,청국장,종규킹,객체왕" delims=",">
    <li>${name}</li>
</c:forTokens>
</ul>
</body>
