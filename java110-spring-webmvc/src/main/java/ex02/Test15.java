...
public class Test15 {
    ...
    // 클라이언트가 보낸 데이터는 메서드의 파라미터 타입에 맞춰서 변환하여 전달한다.
    ...
    public String m2(
            ...
            // 타입이 아닌 경우 파라미터 변수 앞에 @RequestParam을 붙여야한다.
