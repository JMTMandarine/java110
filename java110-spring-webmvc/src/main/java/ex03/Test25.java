...
public class Test25 {
    ...
    //
    // @MarixVariable 애노테이션을 사용하려면 스프링 설정에서 활성화 시켜야 한다.
    // 1) XML 설정
 ...
 // 테스트:
    // http://localhost:8888/app/ex03/test25/search4/car/model=sonata;year=2013/tire/model=true;year=2016
    ...
    // PathVariable에 정규식 표현식 지정하기
    //
    //  {변수명:정규표현식} 
    //
    // 테스트:
    // http://localhost:8888/app/ex03/test25/search5/{l1:[0-9][0-9]} <== 숫자2자리
    //                                               {l2:[0-9][0-9]} 
    //                                               {l3:[0-9][0-9]} 
    //                                               {l4:[0-9][0-9]} 
