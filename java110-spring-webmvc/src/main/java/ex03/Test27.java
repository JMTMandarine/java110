...
// request handler Model 이나  Map 객체에 저장하는 값 중에서
// 세션에도 저장할 값을 지정할 때 다음 애노테이션을 사용한다.
@SessionAttributes({"name","gender"})  // 어떤 값을 session에 저장할지 선언해줌!
public class Test27 {
    // 테스트:
    ...
    public String logout2(SessionStatus status) throws Exception {
        ...
        // => 관리되는 name2,gender2는 관리 대상이 아니다.
